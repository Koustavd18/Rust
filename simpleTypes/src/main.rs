...
fn main() {
    ...
    //
    libs::print_difference( coords.0, coords.1 );   // Uncomment and finish this line
    ...
    libs::print_array(coords_arr);        // and pass it in here (this line doesn't need to change)
